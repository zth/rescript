...
Mocha.describe("Belt_int_test", () => {
  ...
  Mocha.test("operators", () => {
    ...
    Test_utils.eq("File \"belt_int_test.res\", line 45, characters 7-14", -1, -1);
    Test_utils.eq("File \"belt_int_test.res\", line 46, characters 7-14", 1, 1);
    Test_utils.eq("File \"belt_int_test.res\", line 47, characters 7-14", 16, 16);
    Test_utils.eq("File \"belt_int_test.res\", line 48, characters 7-14", 2, 2);
    Test_utils.eq("File \"belt_int_test.res\", line 49, characters 7-14", 2, 2);
  });
});
