...
try {
  ...
  eq("File \"exception_raise_test.res\", line 137, characters 10-17", Stdlib_Exn.asJsExn(e) !== undefined, true);
}
...
try {
  ...
  eq("File \"exception_raise_test.res\", line 141, characters 10-17", Stdlib_Exn.asJsExn(e$1) !== undefined, false);
}
