...
let mkBig = Stdlib_BigInt.fromString;
...
Test.run([
  ...
  "is: bigint"
], Object.is(Stdlib_BigInt.fromString("123456789"), Stdlib_BigInt.fromString("123456789")), eq, true);
...
Test.run([
  ...
  "is: bigint"
], Object.is(Stdlib_BigInt.fromString("123489"), Stdlib_BigInt.fromString("123456789")), eq, false);
...
Test.run([
  ...
  "is: bigint"
], Object.is(Stdlib_BigInt.fromString("000000000"), Stdlib_BigInt.fromString("0")), eq, true);
...
Test.run([
  ...
  "is: bigint"
], Primitive_object.equal(Stdlib_BigInt.fromString("123"), Stdlib_BigInt.fromString("123")), eq, true);
...
Test.run([
  ...
  "is: bigint"
], Stdlib_BigInt.fromString("123") === Stdlib_BigInt.fromString("123"), eq, true);
