...
], Stdlib_Int.range(3, 6, undefined), eq, [
  3,
  4,
  5
]);
...
], Stdlib_Int.range(-3, -1, undefined), eq, [
  -3,
  -2
]);
...
Test.run([
  ...
  "range - start == end"
], Stdlib_Int.range(3, 3, undefined), eq, []);
...
], Stdlib_Int.range(-1, -3, undefined), eq, [
  -1,
  -2
]);
...
Test.run([
  ...
  "clamp"
], Stdlib_Int.clamp(undefined, undefined, 42), eq, 42);
...
Test.run([
  ...
  "clamp - < min"
], Stdlib_Int.clamp(50, undefined, 42), eq, 50);
...
Test.run([
  ...
  "clamp - > min"
], Stdlib_Int.clamp(40, undefined, 42), eq, 42);
...
Test.run([
  ...
  "clamp - < max"
], Stdlib_Int.clamp(undefined, 50, 42), eq, 42);
...
Test.run([
  ...
  "clamp - > max"
], Stdlib_Int.clamp(undefined, 40, 42), eq, 40);
...
Test.run([
  ...
  "clamp - < min, < max"
], Stdlib_Int.clamp(50, 60, 42), eq, 50);
...
Test.run([
  ...
  "clamp - < min, > max"
], Stdlib_Int.clamp(50, 40, 42), eq, 50);
...
Test.run([
  ...
  "clamp - > min, < max"
], Stdlib_Int.clamp(40, 60, 42), eq, 42);
...
Test.run([
  ...
  "clamp - > min, > max"
], Stdlib_Int.clamp(40, 40, 42), eq, 40);
