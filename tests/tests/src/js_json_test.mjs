...
eq("File \"js_json_test.res\", line 51, characters 5-12", Js_json.test(v, "Object"), true);
...
if (typeof ty !== "object") {
  if (ty === "JSONNull") {
    add_test("File \"js_json_test.res\", line 58, characters 24-31", () => ({
      TAG: "Ok",
      _0: true
    }));
  } else {
    console.log(ty);
    add_test("File \"js_json_test.res\", line 61, characters 11-18", () => ({
      TAG: "Ok",
      _0: false
    }));
  }
...
if (typeof ty$1 !== "object") {
  add_test("File \"js_json_test.res\", line 71, characters 16-23", () => ({
    TAG: "Ok",
    _0: false
  }));
} else if (ty$1.TAG === "JSONString") {
  eq("File \"js_json_test.res\", line 70, characters 26-33", ty$1._0, "test string");
} else {
  add_test("File \"js_json_test.res\", line 71, characters 16-23", () => ({
    TAG: "Ok",
    _0: false
...
if (exit === 1) {
  add_test("File \"js_json_test.res\", line 81, characters 18-25", () => ({
    TAG: "Ok",
    _0: false
  }));
}
...
if (exit$1 === 1) {
  add_test("File \"js_json_test.res\", line 91, characters 18-25", () => ({
    TAG: "Ok",
    _0: false
  }));
}
...
function test(v) {
  ...
  let ty = Js_json.classify(json);
  if (typeof ty === "object") {
    return add_test("File \"js_json_test.res\", line 103, characters 18-25", () => ({
      TAG: "Ok",
      _0: false
    }));
  }
  switch (ty) {
    case "JSONFalse" :
      return eq("File \"js_json_test.res\", line 102, characters 24-31", false, v);
    case "JSONTrue" :
      return eq("File \"js_json_test.res\", line 101, characters 23-30", true, v);
    default:
      return add_test("File \"js_json_test.res\", line 103, characters 18-25", () => ({
        TAG: "Ok",
        _0: false
...
if (typeof ty$4 !== "object") {
  add_test("File \"js_json_test.res\", line 145, characters 16-23", () => ({
    TAG: "Ok",
    _0: false
  }));
  ...
  if (typeof ta !== "object") {
    add_test("File \"js_json_test.res\", line 143, characters 18-25", () => ({
      TAG: "Ok",
      _0: false
    }));
  } else if (ta.TAG === "JSONString") {
    if (ta._0 !== "test string") {
      add_test("File \"js_json_test.res\", line 134, characters 15-22", () => ({
        TAG: "Ok",
        _0: false
      }));
    } else {
      ...
      if (typeof ty$5 !== "object") {
        add_test("File \"js_json_test.res\", line 140, characters 22-29", () => ({
          TAG: "Ok",
          _0: false
        }));
      } else if (ty$5.TAG === "JSONNumber") {
        let b = ty$5._0;
        add_test("File \"js_json_test.res\", line 139, characters 38-45", () => ({
          TAG: "Approx",
          _0: 123.0,
          _1: b
        }));
...
eq_at_i("File \"js_json_test.res\", line 219, characters 10-17", json$7, 0, "Number", Primitive_array.get(a, 0));

eq_at_i("File \"js_json_test.res\", line 220, characters 10-17", json$7, 1, "Number", Primitive_array.get(a, 1));

eq_at_i("File \"js_json_test.res\", line 221, characters 10-17", json$7, 2, "Number", Primitive_array.get(a, 2));
...
eq_at_i("File \"js_json_test.res\", line 230, characters 10-17", json$8, 0, "Number", Primitive_array.get(a$1, 0));

eq_at_i("File \"js_json_test.res\", line 231, characters 10-17", json$8, 1, "Number", Primitive_array.get(a$1, 1));

eq_at_i("File \"js_json_test.res\", line 232, characters 10-17", json$8, 2, "Number", Primitive_array.get(a$1, 2));
...
eq_at_i("File \"js_json_test.res\", line 241, characters 10-17", json$9, 0, "Boolean", Primitive_array.get(a$2, 0));

eq_at_i("File \"js_json_test.res\", line 242, characters 10-17", json$9, 1, "Boolean", Primitive_array.get(a$2, 1));

eq_at_i("File \"js_json_test.res\", line 243, characters 10-17", json$9, 2, "Boolean", Primitive_array.get(a$2, 2));
...
if (typeof ty$6 !== "object") {
  add_test("File \"js_json_test.res\", line 271, characters 16-23", () => ({
    TAG: "Ok",
    _0: false
  }));
  ...
  if (typeof ty$7 !== "object") {
    add_test("File \"js_json_test.res\", line 269, characters 18-25", () => ({
      TAG: "Ok",
      _0: false
    }));
    ...
    if (typeof ty$8 !== "object") {
      add_test("File \"js_json_test.res\", line 267, characters 20-27", () => ({
        TAG: "Ok",
        _0: false
      }));
...
try {
  JSON.parse("{{ A}");
  add_test("File \"js_json_test.res\", line 279, characters 11-18", () => ({
    TAG: "Ok",
    _0: false
  }));
} catch (exn) {
  add_test("File \"js_json_test.res\", line 281, characters 17-24", () => ({
    TAG: "Ok",
    _0: true
  }));
}
